...
# スコープ（全機能対応）
SCOPES = "auth:user.id:read offline_access task:task:read task:task:write task:tasklist:read task:tasklist:write task:section:read task:section:write task:comment:read task:comment:write task:attachment:read task:attachment:write task:custom_field:read task:custom_field:write im:message im:message:readonly im:message:send_as_bot im:message.group_msg im:message.group_msg:readonly im:message.group_at_msg:readonly im:message.p2p_msg:readonly im:message:update im:message:recall im:resource im:chat im:chat:readonly im:chat:read im:chat:create im:chat.members:read im:chat.members:write_only docx:document docx:document:readonly docx:document:create docs:doc docs:doc:readonly docs:document.content:read docs:document.comment:read docs:document.comment:create bitable:app bitable:app:readonly drive:drive drive:drive:readonly drive:drive.metadata:readonly drive:drive.search:readonly drive:file drive:file:readonly drive:file:upload drive:file:download wiki:wiki wiki:wiki:readonly wiki:space:read wiki:space:retrieve wiki:node:read wiki:node:retrieve calendar:calendar calendar:calendar:readonly calendar:calendar:read calendar:calendar.event:read calendar:calendar.event:create calendar:calendar.event:update calendar:calendar.event:delete calendar:calendar.free_busy:read contact:contact.base:readonly contact:user.base:readonly contact:user.department:readonly contact:department.base:readonly"
